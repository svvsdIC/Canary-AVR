...
void initialize_timer_counter_0(void) 
{
	...
	// TIMSK0 = (1<<OCIE0A); ********NOT ENABLING THIS FOR PRODUCTION CODE*****************
...
void initialize_timer_counter_1(void) 
{
	...
	// Now enable the interrupt on the compare register A
	//***************************************************************
	// WITH the new design, the GPS sensor will generate the 1Hz interrupt.
	//As a result, we will not enable this interrupt for production code.
	// You can enable this interrupt for lab usage when the GPS is not attached.
	//*******************************************************************
//	TIMSK1 = (1<<OCIE1A);
